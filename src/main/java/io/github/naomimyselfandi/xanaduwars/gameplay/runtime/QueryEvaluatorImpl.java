...
import io.github.naomimyselfandi.xanaduwars.gameplay.query.AbstractQueryEvaluator;
...
final class QueryEvaluatorImpl extends AbstractQueryEvaluator {
    ...
    protected Stream<Rule<?, ?>> contextualRules(Query<?> query) {
        return Stream.concat(
                query instanceof SubjectQuery<?, ?> q ? rules(q.subject(), Type::subjectRules) : Stream.of(),
