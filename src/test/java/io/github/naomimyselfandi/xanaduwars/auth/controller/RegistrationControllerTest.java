...
class RegistrationControllerTest {
    ...
    void register(SeededRng random) {
        ...
        when(accountService.create(any(), any(), any(PlaintextPassword.class))).then(invocation -> {
            ...
            assertThat(invocation.<PlaintextPassword>getArgument(2)).isEqualTo(password);
            return Optional.of(new HumanAccount());
        });
        assertThat(fixture.register(new Registration(username, emailAddress, password)))
