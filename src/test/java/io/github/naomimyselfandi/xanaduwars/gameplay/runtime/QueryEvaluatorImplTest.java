...
class QueryEvaluatorImplTest {
    ...
    private record TestSubjectQuery(Element subject) implements SubjectQuery<Object, Object> {

        @Override
        public Object defaultValue() {
            return QueryEvaluatorImplTest.class;
        }

    }

    private record TestTargetQuery(Element subject, Object target) implements TargetQuery<Object, Object, Object> {
    ...
    void setup() {
        ...
        lenient().when(spellType.subjectRules()).thenReturn(List.of(spellRule));
    ...
    void contextualRules() {
        assertThat(fixture.contextualRules(Object::new)).isEmpty();
    }
