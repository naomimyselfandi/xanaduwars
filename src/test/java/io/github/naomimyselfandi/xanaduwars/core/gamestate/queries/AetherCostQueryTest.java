...
class AetherCostQueryTest {
    ...
    private AetherCostQuery fixture;

    @BeforeEach
    void setup() {
        fixture = new AetherCostQuery(subject, action, List.of(new Object(), new Object()));
    }
    ...
    @Test
    void prologue() {
        when(action.getAetherCost()).thenReturn(script);
