...
public class InfoControllerE2ETest extends AbstractE2ETest {
    ...
    void canGetRuleset(String versionNumber) throws Exception {
        query("/info/ruleset/{version}", versionNumber)
                ...
                .andExpect(jsonPath("$.tileTypes[4].movementTable.Treaded", is(1.0)))
                .andExpect(jsonPath("$.tileTypes[4].movementTable.Wheeled", is(1.0)))
                .andExpect(jsonPath("$.tileTypes[4].movementTable.Soldier", is(1.0)))
