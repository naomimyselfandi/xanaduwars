...
class GameStateImplTest {
    ...
    void setup(SeededRng random) {
        lenient().when(unitType0.id()).thenReturn(new UnitTypeId(0));
        lenient().when(unitType1.id()).thenReturn(new UnitTypeId(1));
        when(ruleset.commanders()).thenReturn(List.of(commander));
        var version = random.nextVersion();
        playerData0 = new PlayerData().playerId(new PlayerId(0)).commander(new CommanderId(0));
        playerData1 = new PlayerData().playerId(new PlayerId(1)).commander(new CommanderId(0));
        playerData2 = new PlayerData().playerId(new PlayerId(2)).commander(new CommanderId(0));
        ...
        gameData = new GameData().version(version);
    ...
    void units() {
        ...
        FieldIteration.forEachField(UnitData.Fields.values(), field -> switch (field) {
            ...
            case unitType -> assertThat(unitData0.unitType()).isEqualTo(new UnitTypeId(0));
        ...
        FieldIteration.forEachField(UnitData.Fields.values(), field -> switch (field) {
            ...
            case unitType -> assertThat(unitData1.unitType()).isEqualTo(new UnitTypeId(1));
