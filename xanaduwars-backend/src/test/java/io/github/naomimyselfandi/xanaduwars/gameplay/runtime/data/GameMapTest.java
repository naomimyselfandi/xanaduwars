...
class GameMapTest {
    ...
    void playerCount(int playerCount) {
        ...
        assertThat(fixture.players())
                .hasSize(playerCount)
                .allSatisfy(player -> FieldIteration.forEachField(PlayerData.Fields.values(),
                        field -> switch (field) {
    ...
    void dimensions(int width, int height) {
        ...
        assertThat(fixture.tiles().stream().map(TileData::tileId))
                .containsExactlyElementsOf(() -> IntStream
                        ...
                        .iterator());
        assertThat(fixture.tiles()).allSatisfy(tile -> FieldIteration.forEachField(TileData.Fields.values(),
                field -> switch (field) {
                    case tileId -> null;
